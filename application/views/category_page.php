...
<main class="wrapper">
	...
	<div class="popular-tours text-center g-heading-v8 g-pt-70 g-pb-70" id="Popular-Tours">
		<div class="container-fluid">
			<h2 class="h2"><em class="block-name">All</em><br> <strong>cafe</strong> list</h2>
			<div class="row">
			...
			<?php
                ...
                foreach ( $cafelist as $cafelist)
                {
                    ...
                    echo '<div class="img-wrapper img-wrapper--shadow"><img src="/matchan/assets/30cafe/'.$cafelist->cimg.'/img1.jpg" style="height:290px; width:100%" alt="ALT" class="img-responsive"></div>';
                    echo ' <div class="popular-tours-item-info"> ';
                    echo '<div class="popular-tours-item-info-inner " style="background:rgba(0,0,0,0.6); ">';
                    echo '<h3 ><a href="/matchan/item_detail/detail/'.$cafelist->cid.'" >'.$cafelist->cname.'</a></h3>';
                    ...
                    echo '<h3>Area: '.$cafelist->carea.'</h7><b3>';
                    echo '<h3>Open Time: '.$cafelist->chour.'</h73>';
                    echo ' </div>';
                    echo '</div>';
	...
	<!-- End Popular Tours Section -->
	 ...
	 <?php 
                $total_pages = ceil($totalrecord / 10); 
                echo ' <div class="text-center">
                        <ul class="pagination">
                            <li><a href="#">«</a></li> ';
                    for ($i=1; $i<=$total_pages; $i++) { 
                        echo "<li><a href='/matchanrebuild/categories?page=".$i."'>".$i."</a><li>"; 
                        };      
